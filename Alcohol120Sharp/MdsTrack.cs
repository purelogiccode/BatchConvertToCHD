...
public sealed record MdsTrack(int Number, byte ModeByte, int SectorSize, long StartLba)
{
    ...
    private const string CueMode1 = "MODE1/2352";
    private const string CueMode2 = "MODE2/2352";
    ...
    public bool IsAudio => ModeByte == ModeAudio;
    ...
    public string? CueTrackType =>
        ModeByte switch
        {
            ModeAudio => "AUDIO",
            ModeMode1 => CueMode1,
            ModeMode2 or ModeMode2Form1 or ModeMode2Form2 => CueMode2,
            _ => null
        };
